...
def predict_scores(
    ...
    for img in test_json["images"]:
        prediction_imgs.append(os.path.join(paths.test_data_path, img["file_name"]))
...
def get_coco_eval_results_autocorr(
    model_weights: str,
    regist_instances: bool = True,
    test_data_tag: str = "test",
    output_path: str = "./output/",
    ...
    evaluator = COCOEvaluator(test_data_tag, cfg, False, output_dir=output_path)
    val_loader = build_detection_test_loader(cfg, "val")

    logger.info("Running COCO evaluation on the auto-corrected pseudolabels with the current model")
